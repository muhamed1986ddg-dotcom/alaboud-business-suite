...
const APP_EN_TRANSLATIONS = {
  ...
  "الموردون والشركات": "Suppliers & Companies",
  الحوالات: "Transfers",
  الأرباح: "Profits",
    ...
    <div className="premium-dashboard">
      <section className="premium-hero dashboard-pro-hero">
        <div className="dashboard-pro-brand">
          ...
          <div>
            ...
            <p>
              v15.3.63 Customers Overdue Tabs <span>● متصل</span>
            </p>
          </div>
        </div>
      ...
      <section className="dashboard-pro-analysis">
        ...
        <div className="dashboard-pro-finance panel-dark">
          <div className="section-heading">
            <h3>حركة رأس المال</h3>
            <button onClick={() => navigate("capital")}>عرض الكل</button>
          </div>
          <p>
...
يرجى التواصل معنا لتسوية الحساب.`;
  ...
  const filteredOverdue = (
    Array.isArray(alerts.rows) ? alerts.rows : []
  ).filter((customer) =>
    `${customer.name || ""} ${customer.phone || ""}`
      .toLowerCase()
      .includes(search.toLowerCase()),
            ...
            <div className="customers-overdue-integrated">
              <div className="customers-overdue-summary">
                <div className="card">
                  ...
                  <strong>{alerts.count || 0}</strong>
                </div>
                <div className="card">
                  <span>إجمالي المبلغ المتأخر</span>
                  <strong>{cad(alerts.totalOverdue || 0)}</strong>
                </div>
              </div>

              {filteredOverdue.length ? (
                filteredOverdue.map((customer) => (
                  <article
                    className="card integrated-overdue-card"
                    key={customer.id}
                  >
                    <div className="integrated-overdue-head">
                      ...
                      <span className="overdue-days-badge">
                        متأخر {customer.overdueDays || 0} يوم
                      </span>
                    </div>
                    ...
                    <div className="integrated-overdue-details">
                      <div>
                        ...
                        <strong>{cad(customer.finalBalance || 0)}</strong>
                      </div>
                      <div>
                        <span>آخر حوالة</span>
                        <strong>{customer.lastTransferNumber || "-"}</strong>
                        <small>{customer.lastTransferDate || "-"}</small>
                      </div>
                      <div>
                        <span>قيمة آخر حوالة</span>
                        <strong>{cad(customer.lastTransferAmount || 0)}</strong>
                      </div>
                      <div>
                        <span>المتبقي منها</span>
                        <strong>
                          {cad(customer.lastTransferRemaining || 0)}
                        </strong>
                      </div>
                    </div>
                    ...
                    <div className="integrated-overdue-actions no-print">
                      <button
                        type="button"
                        className="payment"
                        onClick={() => preparePayment(customer)}
                      >
                        💵 تسجيل دفعة
                      </button>
                      <button
                      ...
                      <button type="button" onClick={() => open(customer.id)}>
                        فتح صفحة العميل
                      </button>
                    </div>
                  </article>
                ...
                <div className="card overdue-empty-state">
    ...
    <>
      <div className="card no-print form">
        ...
        <button
          ...
          onClick={shareCustomerStatement}
        >
...
function SettingsPanel() {
  ...
  const [updateInfo, setUpdateInfo] = useState({
    checking: false,
    status: "",
    version: "v15.3.63 Dashboard Pro",
  });
  ...
  return (
    <section className="settings-page">
      <div className="settings-hero">
        ...
        <span className="settings-version">v15.3.63 Dashboard Pro</span>
      </div>
        ...
        <article className="settings-card">
          ...
          <div className="support-actions">
            ...
            <button
              ...
              onClick={() =>
                navigator.clipboard
                  ?.writeText("v15.3.63 Dashboard Pro")
...
export default function App() {
  ...
  if (invoiceId) {
    ...
    content = (
      <Customers open={setCustomerId} onStatement={setStatementCustomerId} />
    );
  ...
  const menu = [
    ...
    [
      "customers",
      `👥 العملاء${overdueCount ? ` (${overdueCount} متأخر)` : ""}`,
    ],
    ...
    <>
      ...
      >
        <div className="mobile-page-header no-print">
          ...
          <div className="mobile-brand-center">
            ...
            <div className="mobile-brand-copy">
              ...
              <small>v15.3.63 Dashboard Pro</small>
            </div>
          </div>
          <button
        ...
        <main className="app-main-content">
          {showHomeButton && (
            <div className="home-return-bar no-print">
              <button
