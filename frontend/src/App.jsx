...
function CurrencyFlag({ code, className = "" }) {
  ...
  if (goldCodes.includes(normalized)) {
    return (
      <span className={`gold-rate-icon ${className}`} aria-label="gold">
        🪙
      </span>
    );
  }
...
function rateTrend(rate, history = []) {
  const pairHistory = history
    .filter(
      (item) =>
        ...
        item.quoteCurrency === rate.quoteCurrency,
    )
    .sort((a, b) =>
  ...
  if (currentValue > previousValue)
    return { type: "up", symbol: "▲", label: "صعود" };
  if (currentValue < previousValue)
    return { type: "down", symbol: "▼", label: "نزول" };
...
class AppErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.error) {
      return (
        <div className="card customer-error">
...
const APP_EN_TRANSLATIONS = {
  "القائمة الرئيسية": "Main Dashboard",
  الرئيسية: "Home",
  القائمة: "Menu",
  العملاء: "Customers",
  "العملاء المتأخرون": "Overdue Customers",
  الشركات: "Companies",
  الحوالات: "Transfers",
  الأرباح: "Profits",
  "العملات وأسعار الصرف": "Currencies & Exchange Rates",
  "الدَّين العام": "General Debts",
  "رأس المال الكلي": "Total Capital",
  "التقارير الشهرية": "Monthly Reports",
  "إعدادات التنبيهات": "Alert Settings",
  الإعدادات: "Settings",
  المصروفات: "Expenses",
  "حركة رأس المال": "Capital Movement",
  "تسجيل الخروج": "Log out",
  "هل تريد تسجيل الخروج من البرنامج؟":
    "Do you want to log out of the application?",
  "نعم، تسجيل الخروج": "Yes, log out",
  إلغاء: "Cancel",
  "العودة إلى القائمة الرئيسية": "Back to Main Dashboard",
  "شركة العبود التجارية": "AlAboud Trading Company",
  "إدارة الحوالات والحسابات": "Transfers & Accounts Management",
  البريد: "Email",
  "كلمة المرور": "Password",
  "تسجيل الدخول": "Sign in",
  "فشل تسجيل الدخول": "Login failed",
  "جاري تحميل لوحة التحكم…": "Loading dashboard…",
  "إجمالي الحوالات": "Total Transfers",
  "حوالات اليوم": "Today's Transfers",
  ...
  "نشرة أسعار الصرف": "Exchange Rate Board",
  "عرض الكل": "View All",
  "أحدث الحوالات": "Latest Transfers",
  "إضافة حوالة": "Add Transfer",
  "إضافة عميل": "Add Customer",
  "إضافة مصروف": "Add Expense",
  "تقرير سريع": "Quick Report",
  "تحديث أسعار الصرف": "Refresh Exchange Rates",
  "قائمة العملاء": "Customer List",
  "بحث باسم العميل أو رقم الهاتف": "Search by customer name or phone",
  "مجموع الحسابات الكلي": "Total Accounts",
  "مجموع المدفوع": "Total Paid",
  "المجموع النهائي (CAD) المتبقي": "Final Remaining Total (CAD)",
  "المتأخرون أكثر من أسبوع": "Overdue More Than a Week",
  "مجموع الحساب": "Account Total",
  المدفوع: "Paid",
  "فتح الحساب": "Open Account",
  "إضافة دفعة": "Add Payment",
  تعديل: "Edit",
  "واتساب كشف الحساب": "WhatsApp Final Total (CAD)",
  مستحق: "Due",
  مسدد: "Paid",
  "لا يوجد رقم هاتف": "No phone number",
  "حفظ الحوالة": "Save Transfer",
  مدفوع: "Paid",
  "غير مدفوع": "Unpaid",
  "أجور الحوالة": "Transfer Fee",
  "ربح الحوالة": "Transfer Profit",
  "المجموع النهائي (CAD) للعميل": "Customer Final Total (CAD)",
  "سعر التحويل للعميل": "Customer Exchange Rate",
  "السعر الذي يحاسب عليه العميل مقابل كل وحدة من عملة الحوالة":
    "Rate charged to the customer for each transfer currency unit",
  ...
  نزول: "Down",
  ثابت: "Stable",
  "إعدادات التنبيهات وواتساب": "Alerts & WhatsApp Settings",
  "بدء تنبيه التأخير بعد عدد الأيام": "Start overdue alert after days",
  "حد انخفاض السيولة (CAD)": "Low Cash Limit (CAD)",
  "قالب رسالة واتساب (اختياري)": "WhatsApp Message Template (Optional)",
  "حفظ الإعدادات": "Save Settings",
  "ملاحظة:": "Note:",
  اللغة: "Language",
  "طريقة العرض": "Display Mode",
  مضغوط: "Compact",
  مريح: "Comfortable",
  كبير: "Large",
  "العملة الرئيسية": "Primary Currency",
  "حفظ إعدادات العرض": "Save Display Settings",
  "إنشاء حساب": "Create Account",
  "اسم المستخدم": "User Name",
  "البريد الإلكتروني": "Email Address",
  مستخدم: "User",
  مدير: "Manager",
  "مسؤول كامل": "Full Administrator",
  ...
  "لا توجد حوالات.": "No transfers.",
  "لا توجد حوالات في هذا الشهر.": "No transfers this month.",
  العميل: "Customer",
  التاريخ: "Date",
  الرقم: "Number",
  الأجور: "Fees",
  الربح: "Profit",
  "تفاصيل حوالات الشهر": "Monthly Transfer Details",
  "أكثر العملاء تعاملًا خلال الشهر": "Top Customers This Month",
  "جاري التحميل...": "Loading...",
  "حدث خطأ في الصفحة": "Page Error",
      ...
      document.querySelectorAll("body *").forEach((node) => {
        ...
        node.childNodes.forEach((child) => {
          if (child.nodeType === Node.TEXT_NODE) {
            if (english) {
              if (child.__alaboudArabicOriginal === undefined)
                child.__alaboudArabicOriginal = child.nodeValue;
...
function Login({ onLogin }) {
  ...
  async function submitRegister(e) {
    ...
    try {
      ...
      setError(error.response?.data?.message || "تعذر إنشاء الحساب");
    } finally {
      setBusy(false);
    }
  }
  ...
  return (
    <div className="login">
      <form
        className="panel public-account-panel"
        onSubmit={mode === "login" ? submitLogin : submitRegister}
      >
        <img
          className="login-company-logo"
          src="/alaboud-company-logo.webp"
          alt="شركة العبود التجارية"
        />
        ...
        {mode === "login" ? (
          ...
          <>
            ...
            <input
              ...
              required
            />
            <div className="tenant-privacy-note">
              🔒 سيتم إنشاء مساحة بيانات مستقلة لشركتك. لن ترى بيانات أي شركة
              أخرى.
            </div>
          </>
        )}
        ...
        >
          {mode === "login"
            ? "مستخدم جديد؟ إنشاء حساب شركة"
            : "لدي حساب بالفعل — تسجيل الدخول"}
        </button>
        <small>
          يمكن استخدام نفس الحساب على أكثر من هاتف وستظهر نفس البيانات السحابية.
        </small>
      </form>
    </div>
  );
...
function Dashboard({ navigate }) {
  ...
  useEffect(() => {
    ...
    const loadDashboard = async (refreshRates = false) => {
      try {
        ...
        const rows = Array.isArray(transactionsResponse.data)
        ...
        const rateRows = Array.isArray(ratesResponse.data)
          ? ratesResponse.data
          : [];
        const dashboardCurrencyOrder = [
          "USD",
          "CAD",
          "EUR",
          "TRY",
        ...
        rateRows
          .filter((rate) =>
            dashboardCurrencyOrder.includes(
              String(rate.baseCurrency || "").toUpperCase(),
            ),
          )
          .sort((a, b) =>
            String(b.createdAt || "").localeCompare(String(a.createdAt || "")),
        ...
        setDashboardRates(
          dashboardCurrencyOrder
            .map((code) => latestByCurrency.get(code))
            .filter(Boolean),
        );
        setDashboardRateHistory(
  ...
  if (!data)
    return <div className="premium-loading">جاري تحميل لوحة التحكم…</div>;
  ...
  const kpis = [
    ...
    {
      label: "المصروفات",
      value: cad(data.todayExpenses || 0),
      icon: "👛",
      tone: "orange",
      note: "مصروفات اليوم",
    },
    {
      ...
      icon: "👥",
      tone: "purple",
      note: `${noticeData.overdueCount || 0} متأخر`,
    },
  ];
    ...
    <div className="premium-dashboard">
      <section className="premium-hero dashboard-pro-hero">
        <div className="dashboard-pro-brand">
          ...
          <div>
            ...
            <p>
              v16.0.15 Enterprise <span>● متصل</span>
            </p>
          </div>
        </div>
        <div className="dashboard-pro-search">
          ⌕ <span>بحث سريع...</span>
          <kbd>Ctrl + K</kbd>
        </div>
        <div className="dashboard-pro-clock">
          ...
          <small>
            {new Date().toLocaleDateString("ar-CA", {
              weekday: "long",
              year: "numeric",
              month: "long",
              day: "numeric",
      ...
      <section className="premium-kpis">
        {kpis.map((item) => (
          <button
            key={item.label}
            className={`premium-kpi ${item.tone}`}
            onClick={() => {
      ...
      <section className="premium-grid">
        <div className="premium-recent panel-dark">
          ...
          {recent.length ? (
            recent.map((item) => (
              ...
              >
                <div className="recent-currency">
                  <span>{item.currency || "USD"}</span>
                  <small>{item.number || "حوالة"}</small>
                </div>
            ...
            <p className="empty-state">لا توجد حوالات حديثة.</p>
          )}
        </div>
        ...
        <div className="premium-summary panel-dark dashboard-price-bulletin">
          ...
          <div className="dashboard-rate-list">
            {dashboardRates.length ? (
              dashboardRates.map((rate) => (
                <button
                      ...
                      <>
                        <strong className="dashboard-rate-pair">
                          <CurrencyFlag
                            ...
                            className="dashboard-rate-flag"
                          />
                          <span>
                            {rate.baseCurrency}/{rate.quoteCurrency}
                          </span>
                          <span
                            className={`dashboard-rate-trend trend-${trend.type}`}
                          >
                            {trend.symbol}
                          </span>
                        </strong>
                        <span>
                          شراء <b>{Number(rate.buyRate || 0).toFixed(4)}</b>
                        </span>
                        <span>
                          بيع <b>{Number(rate.sellRate || 0).toFixed(4)}</b>
                        </span>
                      </>
                    );
                  })()}
              ...
              <p className="empty-state">لا توجد أسعار صرف مسجلة.</p>
            )}
          </div>
        </div>
      </section>
      ...
      <section className="dashboard-pro-analysis">
        <div className="dashboard-pro-performance panel-dark">
          <div className="section-heading">
            <h3>ملخص الأداء (آخر 7 أيام)</h3>
            <span className="dashboard-pro-period">آخر 7 أيام</span>
          </div>
          <div className="dashboard-pro-chart">
            ...
            <div className="dashboard-pro-bars">
              {[38, 54, 61, 69, 82, 66, 77].map((value, index) => (
                <div className="dashboard-pro-bar-col" key={index}>
                  <div
                    className="dashboard-pro-bar"
                    style={{ height: `${value}%` }}
                  />
            ...
            <svg viewBox="0 0 700 220" preserveAspectRatio="none">
              <polyline points="50,160 150,115 250,102 350,78 450,42 550,85 650,65" />
            </svg>
          </div>
          <div className="dashboard-pro-legend">
            <span>● إجمالي الحوالات (CAD)</span>
        ...
        <div className="dashboard-pro-finance panel-dark">
          <div className="section-heading">
            <h3>⚖️ الميزانية</h3>
            <button onClick={() => navigate("capital-overview")}>
              عرض الكل
            </button>
          </div>
          <p>
            <span>الرصيد الحالي</span>
            <strong>{cad(data.capital || 0)}</strong>
          </p>
          <p>
            <span>الذمم المستحقة</span>
            <strong>{cad(data.receivables || 0)}</strong>
          </p>
          <p>
            <span>العملاء المتأخرون</span>
            <strong>{noticeData.overdueCount || 0}</strong>
          </p>
        </div>
        <div className="dashboard-pro-alerts panel-dark">
          <div className="section-heading">
            <h3>أحدث التنبيهات</h3>
            <button onClick={() => setOpen(!open)}>عرض الكل</button>
          </div>
          {(noticeData.notifications || []).slice(0, 3).map((item) => (
            <div
              className={`dashboard-pro-alert severity-${item.severity}`}
              key={item.id}
            >
              <b>!</b>
              <div>
          ...
          {!noticeData.notifications?.length && (
            <p className="empty-state">لا توجد تنبيهات حالياً.</p>
          )}
        </div>
        <div className="dashboard-pro-stats panel-dark">
          ...
          <p>
            <span>حوالات اليوم</span>
            <strong>{data.todayTransactions || 0}</strong>
          </p>
          <p>
            <span>أرباح اليوم</span>
            <strong>{cad(data.todayProfit)}</strong>
          </p>
          <p>
      ...
      <button className="premium-alert-strip" onClick={() => setOpen(!open)}>
        ...
        <strong>
          {noticeData.count
            ? `${noticeData.count} تنبيهات تحتاج المراجعة`
      ...
      {open && (
        <div className="panel-dark premium-notifications">
          <div className="section-heading">
            <h3>مركز التنبيهات</h3>
            <button onClick={() => setOpen(false)}>إغلاق</button>
          </div>
          {noticeData.notifications.length ? (
            noticeData.notifications.map((item) => (
              <div
              ...
              >
                ...
                {item.customerId && (
                  <button onClick={() => navigate("customers")}>فتح</button>
                )}
              </div>
            ))
          ) : (
...
function Customers({ open }) {
    ...
    api
      ...
      .then((response) => {
        ...
        const direct = rates.find(
          (item) =>
            String(item.baseCurrency || "").toUpperCase() ===
  ...
  async function addTransfer(event) {
    ...
    try {
      const transactionResponse = await api.post("/transactions", {
        ...
        rateSource:
          transferForm.rateMode === "auto" ? "exchange-rates" : "manual",
        rateUpdatedAt:
          transferForm.rateUpdatedAt || selectedRateMeta?.createdAt || null,
      });

      const createdTransaction = transactionResponse.data;
      if (
        transferForm.paymentStatus === "PAID" &&
        createdTransaction?.id &&
        Number(createdTransaction.totalCustomerDue) > 0
      ) {
        await api.post(`/transactions/${createdTransaction.id}/payments`, {
          amount: Number(createdTransaction.totalCustomerDue),
          paymentDate:
            transferForm.transferDate || new Date().toISOString().slice(0, 10),
          method: "CASH",
  ...
  async function addPayment(event) {
    ...
    try {
      ...
      setError(
        error.response?.data?.message || error.message || "تعذر إضافة الدفعة",
      );
    }
  }
  ...
  function createStatementImage(data, customer) {
    ...
    canvas.width = 720;
    canvas.height = Math.ceil((height * 2) / 3);
    ...
    g.addColorStop(0, "#15232f");
    g.addColorStop(1, "#08131c");
    ctx.fillStyle = g;
    ctx.beginPath();
    ctx.roundRect(28, 28, width - 56, height - 56, 38);
    ctx.fill();
    ctx.strokeStyle = "#47545e";
    ctx.lineWidth = 2;
    ctx.stroke();
    ...
    ctx.beginPath();
    ctx.moveTo(55, 292);
    ctx.lineTo(width - 55, 292);
    ctx.stroke();
    let y = 345;
    rows.forEach((item, index) => {
      const amount = Number(item.usdAmount || item.amount || 0)
        .toFixed(2)
        .replace(/\.00$/, "");
      const rate = Number(item.customerRate || item.finalRate || 0)
        .toFixed(4)
        .replace(/0+$/, "")
        .replace(/\.$/, "");
      ctx.direction = "ltr";
      ...
      ctx.fillText(
        `${index + 1}_  ${amount}  🇺🇸  ×  ${rate}  =  ${money(item.formulaResultCad)}  🇨🇦`,
        65,
        y,
      );
      ctx.strokeStyle = "#2b3a45";
      ctx.beginPath();
      ctx.moveTo(55, y + 38);
      ctx.lineTo(width - 55, y + 38);
      ctx.stroke();
      y += rowHeight;
    });
    y += 25;
    ...
    ctx.setLineDash([]);
    y += 75;
    txt("💵  المجموع الإجمالي", 90, y, 38, "#f4f4f5", "left");
    txt(`${money(total)}  🇨🇦`, width - 75, y, 43, "#f4f4f5", "right", "800");
    y += 88;
    txt("👛  الدفعات", 90, y, 38, "#f4f4f5", "left");
    txt(`${money(paid)}  🇨🇦`, width - 75, y, 43, "#ef4444", "right", "800");
    y += 65;
    ctx.setLineDash([12, 10]);
    ctx.strokeStyle = "#65717a";
    ctx.beginPath();
    ...
    ctx.setLineDash([]);
    y += 88;
    txt("🧮  المجموع النهائي", 90, y, 42, "#f4f4f5", "left", "800");
    txt(
      `${money(finalBalance)}  🇨🇦`,
      width - 75,
      y,
    ...
    const d = new Date();
    txt(
      `📅 التاريخ: ${d.toLocaleDateString("en-CA")}`,
      65,
      y,
      28,
      "#aeb7bf",
    ...
    txt(
      `🕘 الوقت: ${d.toLocaleTimeString("ar-CA", { hour: "2-digit", minute: "2-digit" })}`,
      width - 65,
      y,
      28,
      "#aeb7bf",
    ...
    y += 65;
    txt("شكراً لتعاملكم معنا", width / 2, y, 34, "#d8a33f");
    return new Promise((resolve, reject) =>
      canvas.toBlob(
        (b) => (b ? resolve(b) : reject(new Error("تعذر إنشاء الصورة"))),
        "image/png",
        0.96,
      ),
    );
  ...
  async function shareStatementImage(customer) {
    try {
      ...
      const safe = String(customer.name || "customer").replace(
        /[\\/:*?"<>|]+/g,
        "-",
      );
      const file = new File([blob], `كشف-حساب-${safe}.png`, {
        type: "image/png",
      });
      if (navigator.share) {
        try {
      ...
      setError(
        e.response?.data?.message || e.message || "تعذر إنشاء صورة كشف الحساب",
      );
    }
  }
...
يرجى التواصل معنا لتسوية الحساب.`;
    ...
    try {
      ...
      const lines = (
        ...
        const amount = Number(item.usdAmount || 0)
          .toFixed(2)
          .replace(/\.00$/, "");
      ...
      setError(
        requestError.response?.data?.message ||
          "تعذر تجهيز كشف الحساب للواتساب",
      );
    }
  }
  ...
  const customerActionFocus =
    activePanel === "transfer" || activePanel === "payment";
    ...
    <>
      ...
      {!customerActionFocus && (
        <>
          <div className="stats customer-stats-final">
            ...
            <div className="card customer-stat-row">
              ...
              <strong className="customer-stat-value">
                {cad(
                  list.reduce(
                    (sum, item) => sum + Number(item.totalTransactions || 0),
                    0,
                  ),
                )}
              </strong>
            ...
            <div className="card final customer-stat-row">
              ...
              <strong className="customer-stat-value">
                {cad(
                  list.reduce(
                    (sum, item) => sum + Number(item.finalBalance || 0),
                    0,
                  ),
                )}
              </strong>
          ...
          <div className="customer-toolbar card">
            ...
            <button
              onClick={() =>
                setActivePanel(activePanel === "transfer" ? "" : "transfer")
              }
            >
              إضافة حوالة
            </button>
            <button
              onClick={() =>
                setActivePanel(activePanel === "payment" ? "" : "payment")
              }
            >
              إضافة دفعة
            </button>
      ...
      {activePanel === "newCustomer" && (
        <form className="card form edit-panel" onSubmit={addCustomer}>
          ...
          <input
            ...
            min="0"
            step=".01"
            value={customerForm.oldBalance}
            onChange={(e) =>
              setCustomerForm({ ...customerForm, oldBalance: e.target.value })
            }
            placeholder="الحساب القديم (CAD)"
          />
      ...
      {editingCustomer && (
        <form className="card form edit-panel" onSubmit={saveCustomer}>
          ...
          <input
            ...
            min="0"
            step=".01"
            value={editingCustomer.oldBalance || ""}
            onChange={(e) =>
              setEditingCustomer({
                ...editingCustomer,
                oldBalance: e.target.value,
              })
            }
            placeholder="الحساب القديم (CAD)"
          />
      ...
      {activePanel === "transfer" && (
        <div className="customer-action-focus-page">
          ...
          <form
            className="card form edit-panel customer-action-focus-form"
          ...
          >
            ...
            <select
              ...
              onChange={(e) =>
                setTransferForm({ ...transferForm, customerId: e.target.value })
              }
              required
            >
            ...
            <label className="currency-field">
              ...
              >
                {["USD", "EUR", "SYP", "AED", "GBP", "CAD"].map((code) => (
              ...
              <small>
                اختر العملة المرسلة، وسيتم جلب سعر التكلفة مقابل CAD تلقائيًا
              </small>
            </label>
            <label className="currency-field">
            ...
            <label className="currency-field">
              <span className="currency-field-title">
                سعر التكلفة مقابل CAD
              </span>
              <span className="currency-badge cad">CAD</span>
              <div className="rate-mode-switch">
                <button
                  type="button"
                  className={transferForm.rateMode === "auto" ? "active" : ""}
                  onClick={() =>
                    setTransferForm({ ...transferForm, rateMode: "auto" })
                  }
                >
                  السعر الآلي
                </button>
                <button
                  type="button"
                  className={transferForm.rateMode === "manual" ? "active" : ""}
                  onClick={() =>
                    setTransferForm({ ...transferForm, rateMode: "manual" })
                  }
                >
                  سعر يدوي
                </button>
              ...
              <input
                ...
                placeholder="0.0000"
                required
                readOnly={transferForm.rateMode === "auto"}
              />
              <small>
                {selectedRateMeta?.createdAt || selectedRateMeta?.updatedAt
                  ? `آخر تحديث: ${new Date(selectedRateMeta.createdAt || selectedRateMeta.updatedAt).toLocaleString("ar-CA")}`
                  : transferForm.rateMode === "manual"
                    ? "يُستخدم هذا السعر لهذه الحوالة فقط"
                    : "لا يوجد سعر آلي لهذه العملة؛ اختر سعر يدوي"}
              </small>
            </label>
            <label className="currency-field">
              ...
              />
              <small>
                السعر الذي يُحاسب عليه العميل مقابل كل وحدة من عملة الحوالة
              </small>
            </label>
                ...
                <strong>
                  {(
                    (Number(transferForm.amount) || 0) *
                      (Number(transferForm.finalRate) || 0) +
                    (Number(transferForm.transferFee) || 0)
                  ).toFixed(2)}{" "}
                  CAD
                </strong>
              </div>
              <div className="transfer-profit-preview">
                ...
                <strong>
                  {(
                    (Number(transferForm.amount) || 0) *
                      ((Number(transferForm.finalRate) || 0) -
                        (Number(transferForm.costRate) || 0)) +
                    (Number(transferForm.transferFee) || 0)
                  ).toFixed(2)}{" "}
                  CAD
                </strong>
            ...
            <div className="transfer-payment-status">
              ...
              <div className="transfer-payment-status-buttons">
                <button
                  ...
                  onClick={() =>
                    setTransferForm({ ...transferForm, paymentStatus: "PAID" })
                  }
                >
        ...
        <div className="customer-action-focus-page">
          ...
          >
            ...
            <p className="payment-auto-note">
              تُخصم الدفعة تلقائيًا من أقدم الحوالات غير المدفوعة للعميل.
            </p>
            <select
        ...
        <>
          {alerts.count > 0 && (
            <div className="card overdue-panel">
              ...
              {alerts.rows.slice(0, 8).map((customer) => (
                <div className="overdue-row" key={customer.id}>
                  <span>
                    <strong>{customer.name}</strong> — متأخر{" "}
                    {customer.overdueDays} يوم — الرصيد{" "}
                    {cad(customer.finalBalance)}
                  </span>
                  <button
                    className="danger-button"
                    onClick={() => whatsappFinalBalance(customer, true)}
                  >
                    تنبيه واتساب
                  </button>
                </div>
          ...
          <input
            className="card customer-search"
            value={search}
...
function OverdueCustomers({ openCustomer, onStatement, navigateCustomers }) {
  const [data, setData] = useState({
    count: 0,
    totalOverdue: 0,
    largestOverdueBalance: 0,
    largestOverdueCustomer: null,
    oldestCustomer: null,
    oldestDays: 0,
    expectedToday: 0,
    rows: [],
  ...
  async function load() {
    ...
    try {
      ...
      setError(
        requestError.response?.data?.message || "تعذر تحميل العملاء المتأخرين",
      );
    }
  }
  ...
  const filteredTotal = rows.reduce(
    (sum, customer) => sum + Number(customer.finalBalance || 0),
    0,
  );
  const largest = rows.reduce(
    (max, item) =>
      Number(item.finalBalance || 0) > Number(max?.finalBalance || 0)
        ? item
        : max,
    null,
  );
    ...
    <>
      ...
      <div className="stats overdue-top-stats">
        <div className="card overdue-card">
          <span>عدد العملاء المتأخرين</span>
          <strong>{rows.length}</strong>
        </div>
        <div className="card overdue-card">
          <span>إجمالي المبالغ المتأخرة</span>
          <strong>{money(filteredTotal)} CAD</strong>
        </div>
        <div className="card">
          <span>أكبر رصيد متأخر</span>
          <strong>{money(largest?.finalBalance || 0)} CAD</strong>
          <small>{largest?.name || "-"}</small>
        </div>
        <div className="card">
          <span>أكثر عميل تأخرًا</span>
          <strong>{oldest?.name || "-"}</strong>
          <small>{oldest ? `${oldest.overdueDays} يوم` : "0 يوم"}</small>
        </div>
        <div className="card expected-today-card">
          <span>المتوقع تحصيله اليوم</span>
          <strong>{money(data.expectedToday || 0)} CAD</strong>
        </div>
      </div>
      ...
      <div className="overdue-customers-grid">
        {rows.length ? (
          rows.map((customer) => {
            ...
            return (
              <article
                className={`card overdue-customer-card severity-${severity(customer.overdueDays)}`}
                key={customer.id}
              >
                ...
                <div className="overdue-customer-details expanded">
                  <div>
                    ...
                    <strong>{cad(customer.finalBalance)} CAD</strong>
                  </div>
                  <div>
                    <span>إجمالي الحساب</span>
                    <strong>{cad(customer.totalTransactions)} CAD</strong>
                  </div>
                  <div>
                    <span>إجمالي المدفوع</span>
                    <strong>{cad(customer.totalPaid)} CAD</strong>
                  </div>
                  <div>
                    <span>أقدم حوالة غير مدفوعة</span>
                    <strong>{customer.oldestUnpaidDate || "-"}</strong>
                  </div>
                  <div>
                    <span>آخر دفعة</span>
                    <strong>{customer.lastPaymentDate || "-"}</strong>
                  </div>
                  <div>
                    <span>آخر متابعة</span>
                    <strong>{customer.latestAction?.action || "-"}</strong>
                  </div>
                </div>
                ...
                {customer.promiseDate && (
                  <div className="promise-banner">
                    ...
                    {customer.expectedAmount != null && (
                      <> — {money(customer.expectedAmount)} CAD</>
                    )}
                  </div>
                )}
                ...
                <div className="whatsapp-options">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateDraft(customer.id, { messageType: e.target.value })
                    }
                  >
                ...
                <div className="followup-form">
                  <input
                    ...
                    onChange={(e) =>
                      updateDraft(customer.id, { promiseDate: e.target.value })
                    }
                  />
                  <input
                    type="number"
                  ...
                  <input
                    value={draft.notes}
                    onChange={(e) =>
                      updateDraft(customer.id, { notes: e.target.value })
                    }
                    placeholder="ملاحظة مثل: وعد بالدفع يوم الجمعة"
                  />
                </div>
                ...
                <div className="customer-card-actions overdue-actions">
                  ...
                  <button onClick={() => onStatement(customer.id)}>
                    طباعة / PDF
                  </button>
                  <button
                  ...
                  <button onClick={() => saveAction(customer, "CONTACTED")}>
                    تم التواصل
                  </button>
                  <button
                    onClick={() => saveAction(customer, "PROMISE_TO_PAY")}
                  >
                    حفظ وعد الدفع
                  </button>
...
function Customer({ id, back, onStatement }) {
  ...
  async function saveOldBalance(event) {
    ...
    try {
      ...
      setError(
        requestError.response?.data?.message || "تعذر حفظ الحساب القديم",
      );
    } finally {
  ...
  async function addPayment(event) {
    ...
    try {
      ...
      setError(
        error.response?.data?.message || error.message || "تعذر حفظ الدفعة",
      );
    }
  }
  ...
  async function shareCustomerStatementText() {
    try {
      ...
      const total =
        Number(statement.totals?.formulaResultCad || 0) + oldBalance;
      const paid = Number(statement.totals?.paid || 0);
      const finalBalance = Number(
        statement.totals?.remaining || Math.max(total - paid, 0),
      );
    ...
    try {
      ...
      const finalBalance = Number(
        statement.totals?.remaining ??
          Math.max(
            Number(statement.totals?.formulaResultCad || 0) + oldBalance - paid,
            0,
          ),
      );
      ...
      const height =
        headerHeight + rows.length * rowHeight + summaryHeight + footerHeight;
      ...
      drawText("كشف حساب العميل", width / 2, 101, 30, {
        color: "#d8a33f",
        weight: "800",
      });
      drawText(customer.name || "العميل", width / 2, 147, 26, {
        weight: "700",
      });
      drawLine(180);
      ...
      drawText(`${money(oldBalance)} 🇨🇦`, width - sidePadding, y, 24, {
        align: "right",
        color: "#d8a33f",
        weight: "800",
      });
      ...
      drawText(`${money(paid)} 🇨🇦`, width - sidePadding, y, 24, {
        align: "right",
        color: "#ef4444",
        weight: "800",
      });
      ...
      drawText("المجموع النهائي", sidePadding, y, 25, {
        align: "left",
        weight: "800",
      });
      drawText(`${money(finalBalance)} 🇨🇦`, width - sidePadding, y, 28, {
        align: "right",
        color: "#63c443",
        weight: "900",
      });
      ...
      drawText("شكراً لتعاملكم معنا", width / 2, height - 34, 22, {
        color: "#d8a33f",
      });
      ...
      const blob = await new Promise((resolve, reject) => {
        canvas.toBlob(
          (value) =>
            value
              ? resolve(value)
              : reject(new Error("تعذر إنشاء صورة كشف الحساب")),
          "image/png",
          0.96,
        );
      });

      const safeName = String(customer.name || "customer").replace(
        /[\\/:*?"<>|]+/g,
        "-",
      );
      const file = new File([blob], `كشف-حساب-${safeName}.png`, {
        type: "image/png",
      });
      ...
      if (window.AlAboudNative?.shareImageToWhatsApp) {
        const dataUrl = await new Promise((resolve, reject) => {
          ...
          reader.onerror = () =>
            reject(new Error("تعذر تجهيز الصورة للمشاركة"));
  ...
  async function deleteTransaction(transactionId) {
    if (
      !window.confirm("هل أنت متأكد من حذف الحوالة؟ سيتم حذف دفعاتها منطقيًا.")
    )
      return;
    try {
  ...
  const unpaidTransactions = transactions.filter(
    (transaction) => Number(transaction?.remaining || 0) > 0,
  );
  ...
  return (
    <>
      <div className="card no-print form">
        ...
        <button
          className="whatsapp-text-button"
        ...
        <button
          ...
          onClick={() => shareCustomerStatement("share")}
        >
          📤 مشاركة صورة كشف الحساب
        </button>
        <button
          className="statement-save-image-button"
          onClick={() => shareCustomerStatement("save")}
        >
          💾 حفظ الصورة
        </button>
      </div>
      ...
      <div className="stats">
        <form
          className="card old-balance-card old-balance-edit-card"
          onSubmit={saveOldBalance}
        >
        ...
        <div className="card">
          <span>إجمالي الحساب</span>
          <strong>{cad(customer.totalTransactions)}</strong>
        </div>
        <div className="card">
          <span>المدفوع</span>
          <strong>{cad(customer.totalPaid)}</strong>
        </div>
        <div className="card final">
          <span>الحساب النهائي</span>
          <strong>{cad(customer.finalBalance)}</strong>
        </div>
      </div>
      ...
      {unpaidTransactions.length > 0 && (
        <form className="card form" onSubmit={addPayment}>
          <h3>إضافة دفعة</h3>
          <p className="payment-auto-note">
            تُوزع الدفعة تلقائيًا على أقدم الحوالات المستحقة.
          </p>
          <input
            type="number"
            min=".01"
      ...
      {editingTransaction && (
        <form className="card form edit-panel" onSubmit={saveTransaction}>
          ...
          <input
            type="date"
            value={editingTransaction.transferDate || ""}
            onChange={(e) =>
          ...
          <input
            type="number"
            step=".0001"
            value={editingTransaction.costRate}
            onChange={(e) =>
              setEditingTransaction({
                ...editingTransaction,
                costRate: e.target.value,
            ...
            placeholder="سعر التكلفة (CAD)"
          />
          <input
            type="number"
            step=".0001"
            value={editingTransaction.finalRate}
            onChange={(e) =>
              setEditingTransaction({
                ...editingTransaction,
                finalRate: e.target.value,
            ...
            placeholder="سعر الحوالة (CAD)"
          />
          <input
            type="number"
            step=".01"
            value={editingTransaction.transferFee}
            onChange={(e) =>
              setEditingTransaction({
                ...editingTransaction,
                transferFee: e.target.value,
          ...
          />
          <select
            value={editingTransaction.feeMethod}
            onChange={(e) =>
              setEditingTransaction({
                ...editingTransaction,
                feeMethod: e.target.value,
              })
            }
          >
        ...
        <form className="card form edit-panel" onSubmit={savePayment}>
          ...
          <input
            ...
            value={
              ...
              String(editingPayment.date || "").slice(0, 10)
            }
            onChange={(e) =>
              setEditingPayment({
                ...editingPayment,
        ...
        <table>
          ...
          <tbody>
            {transactions.length ? (
                ...
                <tr key={transaction.id}>
                  ...
                  <td>
                    {transaction.transferDate ||
                      String(transaction.createdAt || "").slice(0, 10)}
                  </td>
              ...
              <tr>
                <td colSpan="6">لا توجد حوالات.</td>
              </tr>
            )}
          </tbody>
        </table>
...
function Invoice({ transactionId, back }) {
  ...
  useEffect(() => {
    api
      ...
      .catch((requestError) =>
        setError(requestError.response?.data?.message || "تعذر تحميل الفاتورة"),
      );
  }, [transactionId]);
      ...
      <section className="invoice-sheet">
        <div className="invoice-header">
          ...
          <div>
            ...
            <p>
              <strong>تاريخ الحوالة:</strong> {data.invoiceDate}
            </p>
          </div>
        </div>
        ...
        <div className="invoice-customer">
          <p>
            <strong>اسم العميل:</strong> {data.customer.name}
          </p>
          <p>
            <strong>الهاتف:</strong> {data.customer.phone || "-"}
          </p>
          <p>
        ...
        <table>
          <tbody>
            ...
            <tr>
              <th>سعر الحوالة</th>
              <td>{Number(t.finalRate || 0).toFixed(4)}</td>
            </tr>
            <tr>
              <th>أجور الحوالة</th>
              <td>{money(t.transferFee)}</td>
            </tr>
            <tr>
              <th>الإجمالي المطلوب</th>
              <td>{money(t.totalCustomerDue)}</td>
            </tr>
            <tr>
              <th>المدفوع</th>
              <td>{money(t.paid)}</td>
...
function Statement({ customerId, back }) {
  ...
  return (
    <>
      ...
      {data && (
        <section className="invoice-sheet simple-customer-statement" dir="rtl">
          <div className="simple-statement-heading">
            {data.company.logoDataUrl && (
              <img src={data.company.logoDataUrl} alt={data.company.name} />
            )}
            <h1>{data.company.name}</h1>
            ...
            <table className="simple-statement-table">
              ...
              <tbody>
                {data.transactions.length ? (
                  ...
                  <tr>
                    <td colSpan="4">لا توجد حوالات في هذه الفترة.</td>
                  </tr>
                )}
              </tbody>
            </table>
          ...
          <div className="simple-statement-total">
            ...
            <strong>
              {money(
                Math.max(
                  Number(
                    data.totals.formulaResultCad ??
                      data.transactions.reduce(
                        (sum, item) => sum + Number(item.formulaResultCad || 0),
                        0,
                      ),
...
function Transactions({ openInvoice }) {
  ...
  async function markTransactionPaid(transaction) {
    ...
    try {
      ...
      setError(
        requestError.response?.data?.message || "تعذر تسجيل الحوالة كمدفوعة",
      );
    }
  }
  ...
  return (
    <>
      ...
      <form className="card form" onSubmit={add}>
        ...
        <input
          type="date"
          value={f.transferDate}
          onChange={(e) => setF({ ...f, transferDate: e.target.value })}
          required
        />
        <label className="currency-field">
          <span className="currency-field-title">عملة الحوالة</span>
        ...
        <label className="currency-field">
          ...
          <div className="rate-mode-switch">
            <button
              type="button"
              className={f.rateMode === "auto" ? "active" : ""}
              onClick={() => setF({ ...f, rateMode: "auto" })}
            >
              السعر الآلي
            </button>
            <button
              type="button"
              className={f.rateMode === "manual" ? "active" : ""}
              onClick={() => setF({ ...f, rateMode: "manual" })}
            >
              سعر يدوي
            </button>
          </div>
          <input
            ...
            value={f.costRate}
            onChange={(e) =>
              setF({ ...f, costRate: e.target.value, rateMode: "manual" })
            }
            placeholder="0.0000"
            required
            readOnly={f.rateMode === "auto"}
          />
          <small>
            {rateMeta?.createdAt || rateMeta?.updatedAt
              ? `آخر تحديث: ${new Date(rateMeta.createdAt || rateMeta.updatedAt).toLocaleString("ar-CA")}`
              : f.rateMode === "manual"
                ? "يُستخدم هذا السعر لهذه الحوالة فقط"
                : "لا يوجد سعر آلي؛ اختر سعر يدوي"}
          </small>
        </label>
        <label className="currency-field">
          <span className="currency-field-title">سعر التحويل للعميل</span>
          ...
          <input
            ...
            step=".0000001"
            value={f.finalRate}
            onChange={(e) => setF({ ...f, finalRate: e.target.value })}
            placeholder="0.0000"
            required
          />
        ...
        <div className="transfer-calculation-grid">
          <div className="transfer-total-preview">
            ...
            <strong>
              {(
                (Number(f.amount) || 0) * (Number(f.finalRate) || 0) +
                (Number(f.transferFee) || 0)
              ).toFixed(2)}{" "}
              CAD
            </strong>
          </div>
          <div className="transfer-profit-preview">
            ...
            <strong>
              {(
                (Number(f.amount) || 0) *
                  ((Number(f.finalRate) || 0) - (Number(f.costRate) || 0)) +
                (Number(f.transferFee) || 0)
              ).toFixed(2)}{" "}
              CAD
            </strong>
        ...
        <label className="currency-field">
          ...
          <input
            ...
            step=".01"
            value={f.transferFee}
            onChange={(e) => setF({ ...f, transferFee: e.target.value })}
            placeholder="0.00"
          />
        </label>
        <select
          value={f.feeMethod}
          onChange={(e) => setF({ ...f, feeMethod: e.target.value })}
        >
          <option value="ADD">إضافة الأجور</option>
          <option value="DEDUCT">خصم الأجور</option>
        </select>
        ...
        <div className="transfer-payment-choice">
          <div className="transfer-payment-choice-title">
            ...
            <small>
              الحوالة غير المدفوعة تُحتسب تلقائيًا ضمن رصيد «الدين لنا».
            </small>
          </div>
          <div className="transfer-payment-choice-buttons">
            <button
              type="button"
              className={f.paymentStatus === "PAID" ? "is-active paid" : ""}
            ...
            <button
              type="button"
              className={f.paymentStatus === "UNPAID" ? "is-active unpaid" : ""}
      ...
      {editingTransaction && (
        <form
          className="card form edit-panel transaction-edit-panel no-print"
        ...
        >
            ...
            <strong>
              {(
                (Number(editingTransaction.amount) || 0) *
                  (Number(editingTransaction.finalRate) || 0) +
                (editingTransaction.feeMethod === "ADD"
                  ? Number(editingTransaction.transferFee) || 0
                  : 0)
              ).toFixed(2)}{" "}
              CAD
            </strong>
          ...
          <div className="transaction-edit-actions">
            <button disabled={editSaving}>
              {editSaving ? "جاري الحفظ..." : "حفظ تعديل الحوالة"}
            </button>
            <button type="button" onClick={() => setEditingTransaction(null)}>
              إلغاء
            </button>
            ...
            {list.length ? (
              list.map((transaction) => (
                <tr key={transaction.id}>
                  ...
                  <td>
                    <span
                      className={`transfer-payment-badge ${transaction.paymentStatus === "PAID" ? "paid" : "unpaid"}`}
                    >
                  ...
                  <td>
                    <button onClick={() => openInvoice(transaction.id)}>
                      فتح
                    </button>
                  </td>
                  <td>
              ...
              <tr>
                <td colSpan="9">لا توجد حوالات.</td>
              </tr>
            )}
          </tbody>
        </table>
...
function Profits() {
  ...
  const [filters, setFilters] = useState({ from: "", to: "" });
  const load = () =>
    api.get("/profits", { params: filters }).then((r) => setData(r.data));
  useEffect(() => {
    load();
  }, []);
  ...
  return (
    <>
      ...
      <div className="stats">
        ...
        <div className="card">
          <span>ربح فرق السعر</span>
          <strong>{money(data.exchangeProfit)}</strong>
        </div>
        <div className="card">
          <span>أجور الحوالات</span>
          <strong>{money(data.transferFees)}</strong>
        </div>
        <div className="card">
        ...
        <div className="card final">
          ...
          <strong>{money(data.netProfit)}</strong>
        </div>
      </div>
      <div className="card tablewrap">
...
function ExchangeRates() {
  ...
  const [goldForm, setGoldForm] = useState({
    ...
    buyRate: "",
    sellRate: "",
    notes: "سعر غرام الذهب",
  });
  const [refreshing, setRefreshing] = useState(false);
  const [message, setMessage] = useState("");

  const trendFor = (rate) => rateTrend(rate, history);
  const isGoldRate = (rate) =>
    String(rate.baseCurrency || "").startsWith("XAU");
  ...
  const load = async () => {
    ...
    try {
      ...
      setMessage(
        error.response?.data?.message ||
          "تعذر تحميل أسعار الصرف. حاول التحديث مرة أخرى.",
      );
    }
  };
  ...
  const hasSyrianPound = storedCurrencyRates.some(
    (rate) => rate.baseCurrency === "SYP" || rate.quoteCurrency === "SYP",
  );
  const currencyRates = hasSyrianPound
    ? storedCurrencyRates
    : [
        ...storedCurrencyRates,
        {
    ...
    <>
      ...
      <div className="card auto-rate-bar">
        <div>
          ...
          <p>
            العملات والليرة السورية وأسعار الذهب تتحدث تلقائيًا كل ساعة. يبقى
            آخر سعر محفوظ إذا تعذر أحد المصادر.
          </p>
        </div>
      ...
      <div className="rates-entry-grid">
        <form className="card form" onSubmit={add}>
          ...
          >
            {["CAD", "USD", "EUR", "SYP", "AED", "GBP", "TRY"].map((x) => (
          ...
          <select
            value={f.quoteCurrency}
            onChange={(e) => setF({ ...f, quoteCurrency: e.target.value })}
          >
            {["USD", "CAD", "EUR", "SYP", "AED", "GBP", "TRY"].map((x) => (
              <option key={x} value={x}>
                {currencyLabel(x)}
              </option>
            ))}
          ...
          <input
            ...
            step=".000001"
            value={f.buyRate}
            onChange={(e) => setF({ ...f, buyRate: e.target.value })}
          ...
          <input
            ...
            step=".000001"
            value={f.sellRate}
            onChange={(e) => setF({ ...f, sellRate: e.target.value })}
        ...
        <form className="card form gold-rate-form" onSubmit={addGold}>
          ...
          <select
            value={goldForm.baseCurrency}
            onChange={(e) =>
              setGoldForm({ ...goldForm, baseCurrency: e.target.value })
            }
          >
          ...
          <select
            value={goldForm.quoteCurrency}
            onChange={(e) =>
              setGoldForm({ ...goldForm, quoteCurrency: e.target.value })
            }
          >
          ...
          <input
            type="number"
            step=".01"
            value={goldForm.buyRate}
            onChange={(e) =>
              setGoldForm({ ...goldForm, buyRate: e.target.value })
            }
            placeholder="سعر شراء الغرام"
            required
          />
          <input
            type="number"
            step=".01"
            value={goldForm.sellRate}
            onChange={(e) =>
              setGoldForm({ ...goldForm, sellRate: e.target.value })
            }
            placeholder="سعر بيع الغرام"
            required
          />
          <input
            value={goldForm.notes}
            onChange={(e) =>
              setGoldForm({ ...goldForm, notes: e.target.value })
            }
            placeholder="ملاحظات"
          />
            ...
            {currencyRates.length ? (
              currencyRates.map((r) => {
                ...
                return (
                  <tr
                    key={r.id}
                    className={`rate-row rate-${trend.type} ${r.baseCurrency === "SYP" || r.quoteCurrency === "SYP" ? "syp-highlight" : ""}`}
                  >
                    <td>
                      <span className="currency-badge currency-with-flag">
                        <CurrencyFlag code={r.baseCurrency} />
                        <span>
                          {currencyInfo[r.baseCurrency]?.name || r.baseCurrency}
                        </span>
                        <small>{r.baseCurrency}</small>
                      </span>
                    </td>
                    <td>
                      <span className="currency-badge currency-with-flag">
                        <CurrencyFlag code={r.quoteCurrency} />
                        <span>
                          {currencyInfo[r.quoteCurrency]?.name ||
                            r.quoteCurrency}
                        </span>
                        <small>{r.quoteCurrency}</small>
                      </span>
                    </td>
                    ...
                    <td>
                      <span
                        className={`trend trend-${r.sypPlaceholder ? "new" : trend.type}`}
                      >
                        {r.sypPlaceholder
                          ? "● بانتظار السعر"
                    ...
                    <td>
                      <span
                        className={`source-badge ${["FRANKFURTER", "EXCHANGE_RATE_API", "GOLD_API"].includes(r.source) ? "auto" : "manual"}`}
                      >
                        {r.sypPlaceholder
                          ? "سوري"
              ...
              <tr>
                <td colSpan="7">لا توجد أسعار عملات مسجلة.</td>
              </tr>
            )}
          </tbody>
        </table>
            ...
            {goldRates.length ? (
              goldRates.map((r) => {
                ...
                return (
                  <tr
                    key={r.id}
                    className={`rate-row gold-rate-row rate-${trend.type}`}
                  >
                    <td>
                      <span className="gold-karat-badge">
                        🪙 {goldLabel(r.baseCurrency)}
                      </span>
                    </td>
                    <td>
                      <span className="currency-badge currency-with-flag">
                    ...
                    <td className="sell-rate">
                      <strong>{money(r.sellRate)}</strong>
                    </td>
                    <td>
              ...
              <tr>
                <td colSpan="6">
                  لا توجد أسعار ذهب مسجلة. أضف سعر الذهب من النموذج أعلاه.
                </td>
              </tr>
            )}
          </tbody>
      ...
      <div className="exchange-rates-summary">
        <div>
          ...
          <strong>{currencyRates.length}</strong>
          <small>أزواج عملات مسجلة</small>
        </div>
        <div>
          <span>أفضل سعر اليوم</span>
          <strong>
            {currencyRates.length
              ? `${currencyRates[0].baseCurrency}/${currencyRates[0].quoteCurrency}`
              : "—"}
          </strong>
          <small>آخر سعر محدث</small>
        </div>
        <div>
          <span>متوسط التغيير</span>
          <strong className="positive">+0.28%</strong>
          <small>مؤشر تقريبي</small>
        </div>
        <div>
          <span>الذهب</span>
          <strong>GOLD/CAD</strong>
          <small>سعر يدوي</small>
        </div>
      </div>
...
function GeneralDebts() {
  ...
  async function load() {
    try {
      const { data } = await api.get("/general-debts", {
        params: { type: filter },
      });
      setData({
  ...
  const currencyMeta = Object.fromEntries(
    debtCurrencies.map((item) => [item.code, item]),
  );
  ...
  return (
    <>
      ...
      <div className="card debt-currency-summary">
        <div className="debt-currency-summary-head">
          <div>
            ...
            <p>
              يظهر مجموع دين لنا ودين علينا وصافي الدين لكل عملة بشكل مستقل.
            </p>
          </div>
        </div>
        <div className="debt-currency-totals">
          {debtCurrencies.map((currency) => {
            const total = data.totalsByCurrency?.[currency.code] || {
              receivable: 0,
              payable: 0,
              net: 0,
            };
            return (
              <div className="debt-currency-total card" key={currency.code}>
                ...
                <div className="debt-currency-row receivable">
                  <span>دين لنا</span>
                  <b>
                    {money(total.receivable)} {currency.symbol}
                  </b>
                </div>
                <div className="debt-currency-row payable">
                  <span>دين علينا</span>
                  <b>
                    {money(total.payable)} {currency.symbol}
                  </b>
                </div>
                <div className="debt-currency-row net">
                  <span>الصافي</span>
                  <b>
                    {money(total.net)} {currency.symbol}
                  </b>
                </div>
              </div>
            );
      ...
      <div className="card debt-tabs">
        ...
        <button type="button" onClick={() => setFilter("RECEIVABLE")}>
          دين لنا
        </button>
        <button type="button" onClick={() => setFilter("PAYABLE")}>
          دين علينا
        </button>
      </div>
          ...
          >
            ...
            {openDebts.map((item) => (
              <option key={item.id} value={item.id}>
                {item.type === "RECEIVABLE" ? "لنا" : "علينا"} —{" "}
                {item.partyName} — متبقي {money(item.remaining)} {item.currency}
              </option>
            ))}
          </select>
            ...
            {data.rows.length ? (
              data.rows.map((item) => (
                <tr key={item.id}>
                  <td>
                    <span
                      className={`debt-type ${item.type === "RECEIVABLE" ? "receivable" : "payable"}`}
                    >
                  ...
                  <td>
                    <span className="debt-table-currency">
                      {currencyMeta[item.currency]?.flag || "💱"}{" "}
                      {item.currency}
                    </span>
                  </td>
                  <td>{item.dueDate || "-"}</td>
              ...
              <tr>
                <td colSpan="9">لا توجد ديون مسجلة.</td>
              </tr>
            )}
          </tbody>
        </table>
...
function PartnerProfile({ id, back }) {
  ...
  async function load() {
    try {
      ...
      setError(
        requestError.response?.data?.message || "تعذر تحميل المورد أو الشركة",
      );
    }
  }
  ...
  if (showStatement)
    return (
      <PartnerStatement partnerId={id} back={() => setShowStatement(false)} />
    );
  if (error && !data)
    return (
      <div className="card customer-error">
  ...
  return (
    <>
      ...
      <div className="card">
        <p>
          <strong>المسؤول:</strong> {data.partner.contactName || "-"}
        </p>
        <p>
          <strong>الهاتف:</strong> {data.partner.phone || "-"}
        </p>
        <p>
          <strong>واتساب:</strong> {data.partner.whatsapp || "-"}
        </p>
        <p>
        ...
        <p>
          ...
          {[data.partner.city, data.partner.country]
            .filter(Boolean)
            .join("، ") || "-"}
        </p>
      </div>
      ...
      <form className="card form" onSubmit={addPayment}>
        <select
          ...
          onChange={(e) =>
            setPayment({ ...payment, direction: e.target.value })
          }
        >
...
function PartnerStatement({ partnerId, back }) {
  ...
  async function load() {
    try {
      const response = await api.get(`/partners/${partnerId}/statement`, {
        params: filters,
      });
      setData(response.data);
    } catch (requestError) {
  ...
  function sendWhatsApp() {
    if (!data) return;
    const phone = String(
      data.partner.whatsapp || data.partner.phone || "",
    ).replace(/\D/g, "");
    if (!phone) {
      ...
      {data && (
        <section className="invoice-sheet">
          <div className="invoice-header">
            ...
            <div>
              <p>
                <strong>الجهة:</strong> {data.partner.name}
              </p>
              <p>
                <strong>الفترة:</strong> {data.from || "البداية"} إلى{" "}
                {data.to || "اليوم"}
              </p>
            </div>
          </div>
          ...
          <div className="card final">
            ...
            <strong>{money(data.finalBalance)}</strong>
          </div>
        </section>
      )}
    </>
...
function Partners({ open }) {
  ...
  async function load() {
    try {
      ...
      setError(
        requestError.response?.data?.message || "تعذر تحميل الموردين والشركات",
      );
    }
  }
  ...
  return (
    <>
      ...
      <div className="stats">
        <div className="card receivable-card">
          <span>إجمالي دين لنا</span>
          <strong>{money(data.totals.receivable)}</strong>
        </div>
        <div className="card payable-card">
          <span>إجمالي دين علينا</span>
          <strong>{money(data.totals.payable)}</strong>
        </div>
        <div className="card final">
          <span>الصافي</span>
            ...
            {data.rows.length ? (
              data.rows.map((partner) => (
                <tr key={partner.id}>
                  ...
                  <td>{partner.phone || "-"}</td>
                  <td>{money(partner.receivable)}</td>
                  <td>{money(partner.payable)}</td>
                  <td>
                    <strong>{money(partner.net)}</strong>
                  </td>
                  <td>
              ...
              <tr>
                <td colSpan="7">لا توجد شركات أو موردون.</td>
              </tr>
            )}
          </tbody>
        </table>
...
function CapitalOverview() {
  ...
  async function deleteCapital(item) {
    if (
      !window.confirm(
        `هل تريد حذف حركة رأس المال بقيمة ${money(item.amount)} ${item.currency || "CAD"}؟`,
      )
    )
      return;
    setError("");
  ...
  if (!data)
    return (
      <>
        <h2>رأس المال الكلي</h2>
        {error ? (
          <div className="card customer-error">{error}</div>
        ) : (
          <p>جاري التحميل...</p>
        )}
      </>
    ...
    data.turnoverRate >= 3
      ...
      : data.turnoverRate >= 2
        ...
        : data.turnoverRate >= 1
          ? "جيد"
          : "منخفض";
  const capitalIn = movements
    .filter((item) => item.type === "IN")
    .reduce((sum, item) => sum + Number(item.amount || 0), 0);
  const capitalOut = movements
  ...
  return (
    <>
      ...
      <form
        className="card form capital-manage-form no-print"
        onSubmit={addCapital}
      >
        ...
        <input
          value={form.description}
          onChange={(e) => setForm({ ...form, description: e.target.value })}
          placeholder="الوصف أو سبب الإضافة / السحب"
        />
        <button>
          {form.type === "IN" ? "إضافة رأس المال" : "تسجيل السحب"}
        </button>
      </form>

      {editing && (
        <form
          className="card form edit-panel capital-edit-form no-print"
          onSubmit={saveEdit}
        >
          ...
          <tbody>
            {movements.length ? (
              movements.map((item) => (
                <tr key={item.id}>
                  <td>
                    {item.date || String(item.createdAt || "").slice(0, 10)}
                  </td>
                  <td>
                    <span
                      className={`capital-type-badge ${item.type === "IN" ? "capital-in" : "capital-out"}`}
                    >
              ...
              <tr>
                <td colSpan="6">لا توجد حركات رأس مال مسجلة.</td>
              </tr>
            )}
          </tbody>
        </table>
      ...
      <div className="stats">
        ...
        <div className="card">
          ...
          <strong>{money(data.monthlyProfit)}</strong>
        </div>
        <div className="card">
          <span>مصروفات الشهر</span>
          <strong>{money(data.monthlyExpenses)}</strong>
        </div>
      </div>
      ...
      <div className="card capital-formula">
        ...
        <p>
          <strong>إجمالي قيمة الحوالات الشهرية ÷ رأس المال المستخدم</strong>
        </p>
        <p>
          النتيجة الحالية:{" "}
          <strong>{Number(data.turnoverRate).toFixed(2)} مرة</strong> خلال شهر{" "}
          {data.month}.
        </p>
      </div>
    </>
...
function MonthlyReport() {
  ...
  async function load() {
    ...
    try {
      ...
      setError(
        requestError.response?.data?.message || "تعذر تحميل التقرير الشهري",
      );
    }
  }
    ...
    <>
      ...
      <div className="stats">
        <div className="card transfer-total-card">
          ...
          <strong>{money(s.transferTotal)}</strong>
        </div>
        <div className="card">
          <span>عدد الحوالات</span>
          <strong>{s.transferCount}</strong>
        </div>
        <div className="card">
          <span>متوسط الحوالة</span>
          <strong>{money(s.averageTransfer)}</strong>
        </div>
        <div className="card">
          <span>أكبر حوالة</span>
          <strong>{money(s.largestTransfer)}</strong>
        </div>
        <div className="card">
          <span>أصغر حوالة</span>
          <strong>{money(s.smallestTransfer)}</strong>
        </div>
      </div>
      ...
      <div className="stats">
        <div className="card">
          <span>أجور الحوالات</span>
          <strong>{money(s.feesTotal)}</strong>
        </div>
        <div className="card">
          <span>ربح فرق السعر</span>
          <strong>{money(s.exchangeProfit)}</strong>
        </div>
        <div className="card">
          <span>إجمالي الربح</span>
      ...
      <div className="stats">
        <div className="card">
          ...
          <strong>{money(s.paymentsReceived)}</strong>
        </div>
        <div className="card receivable-card">
          <span>إضافات رأس المال</span>
          <strong>{money(s.capitalIn)}</strong>
        </div>
        <div className="card payable-card">
          <span>سحوبات رأس المال</span>
          <strong>{money(s.capitalOut)}</strong>
        </div>
        <div className="card">
          <span>صافي حركة رأس المال</span>
          <strong>{money(s.netCapitalMovement)}</strong>
        </div>
      </div>
        ...
        <table>
          ...
          <tbody>
            {data.daily.length ? (
              ...
              <tr>
                <td colSpan="4">لا توجد حوالات في هذا الشهر.</td>
              </tr>
            )}
          </tbody>
        </table>
        ...
        <table>
          ...
          <tbody>
            {data.transactions.length ? (
              ...
              <tr>
                <td colSpan="5">لا توجد حوالات.</td>
              </tr>
            )}
          </tbody>
        </table>
    ...
    >
      ...
      <form className="card form settings-form" onSubmit={save}>
        ...
        <input
          ...
          onChange={(e) =>
            setSettings({ ...settings, overdueDays: e.target.value })
          }
        />
        ...
        <input
          ...
          min="0"
          step=".01"
          value={settings.lowCashLimit}
          onChange={(e) =>
            setSettings({ ...settings, lowCashLimit: e.target.value })
          }
        />
      ...
      <div className={embedded ? "settings-help" : "card"}>
        ...
        <p>
          زر واتساب يفتح الرسالة جاهزة للإرسال. الإرسال التلقائي دون ضغط يحتاج
          ربط WhatsApp Business API رسمي.
        </p>
      </div>
    </div>
  );
...
function SettingsPanel() {
  const savedUser = (() => {
    try {
      return JSON.parse(localStorage.getItem("afs_user") || "{}");
    } catch {
      return {};
    }
  })();
  ...
  const [language, setLanguage] = useState(
    localStorage.getItem("alaboud_language") || "ar",
  );
  const [displayMode, setDisplayMode] = useState(
    localStorage.getItem("alaboud_display_mode") || "comfortable",
  );
  const [currency, setCurrency] = useState(
    localStorage.getItem("alaboud_primary_currency") || "CAD",
  );
  const [message, setMessage] = useState("");
  const [updateInfo, setUpdateInfo] = useState({
    checking: false,
    status: "",
    version: "v16.0.15 Enterprise",
  });
  ...
  const [lastBackupAt, setLastBackupAt] = useState(
    localStorage.getItem("alaboud_last_backup_at") || "",
  );
  ...
  function chooseCompanyLogo(event) {
    ...
    if (file.size > 1024 * 1024) {
      setMessage("حجم الشعار يجب أن يكون أقل من 1 MB");
      return;
    }
    const reader = new FileReader();
    reader.onload = () =>
  ...
  async function saveCompanyProfile(event) {
    ...
    try {
      ...
      window.dispatchEvent(
        new CustomEvent("alaboud-company-updated", { detail: data }),
      );
      setMessage("تم حفظ اسم وشعار الشركة بنجاح");
    } catch (error) {
      setMessage(error.response?.data?.message || "تعذر حفظ هوية الشركة");
    } finally {
  ...
  function savePreferences() {
    ...
    setMessage(
      language === "ar" ? "تم حفظ إعدادات العرض" : "Display settings saved",
    );
  }
  ...
  async function checkUpdates() {
    ...
    try {
      ...
      setUpdateInfo((current) => ({
        ...current,
        checking: false,
        status: "تعذر التحقق من حالة التحديث",
      }));
    }
  }
  ...
  async function downloadBackup() {
    ...
    try {
      ...
      link.href = url;
      link.download = `alaboud-backup-${stamp}.json`;
      document.body.appendChild(link);
      link.click();
      link.remove();
      ...
      setMessage(
        error.response?.data?.message || "تعذر إنشاء النسخة الاحتياطية",
      );
    } finally {
      setBackupBusy(false);
    }
  ...
  async function restoreBackup(event) {
    ...
    if (
      !window.confirm(
        "سيتم استبدال بيانات هذه الشركة بمحتوى النسخة الاحتياطية. هل تريد المتابعة؟",
      )
    )
      return;
    setBackupBusy(true);
    ...
    try {
      ...
      setMessage(
        response.data?.message || "تمت استعادة النسخة الاحتياطية بنجاح",
      );
  ...
  return (
    <section className="settings-page">
      <div className="settings-hero">
        ...
        <span className="settings-version">v16.0.15 Enterprise</span>
      </div>
      ...
      <div className="settings-grid">
        <article className="settings-card settings-backup-card">
          ...
          <p className="settings-help">
            تنزيل نسخة كاملة من بيانات شركتك أو استعادتها لاحقًا.
          </p>
          <div className="settings-backup-actions">
            <button
              ...
              disabled={backupBusy}
            >
              {backupBusy ? "جاري التنفيذ..." : "إنشاء نسخة احتياطية"}
            </button>
            <label className="settings-restore-button">
          ...
          <small>
            آخر نسخة:{" "}
            {lastBackupAt
              ? new Date(lastBackupAt).toLocaleString("ar-CA")
        ...
        <article className="settings-card">
          ...
          <div className="settings-card-title settings-subtitle">
            <span>🖥️</span>
          ...
          <div className="settings-choice-grid three">
            <button
              type="button"
              className={displayMode === "compact" ? "selected" : ""}
            ...
            <button
              type="button"
              className={displayMode === "comfortable" ? "selected" : ""}
            ...
            <button
              type="button"
              className={displayMode === "large" ? "selected" : ""}
          ...
          >
            {["CAD", "USD", "EUR", "GBP", "AED", "TRY", "SYP"].map((code) => (
              <option key={code} value={code}>
                {code}
              </option>
            ))}
        ...
        <article className="settings-card settings-alerts-embedded">
          <div className="settings-card-title">
            <span>🔔</span>
            <h3>إعدادات التنبيهات وواتساب</h3>
          </div>
        ...
        <article className="settings-card company-branding-settings">
          <div className="settings-card-title">
            <span>🏢</span>
            <h3>معلومات وهوية الشركة</h3>
          </div>
          <p className="settings-help">
            اسم وشعار مستقلان لهذه الشركة ويظهران على جميع الأجهزة عند تسجيل
            الدخول بنفس الحساب.
          </p>
          <form className="settings-form-modern" onSubmit={saveCompanyProfile}>
            <div className="company-logo-preview">
              <img
                src={companyProfile.logoDataUrl || "/alaboud-company-logo.webp"}
                alt={companyProfile.name || "شعار الشركة"}
              />
            </div>
            <input
            ...
            {companyProfile.logoDataUrl && (
              <button
                ...
                onClick={() =>
                  setCompanyProfile({ ...companyProfile, logoDataUrl: "" })
                }
              >
                حذف الشعار الحالي
              </button>
            )}
            <button disabled={companySaving}>
              {companySaving ? "جاري الحفظ..." : "حفظ اسم وشعار الشركة"}
            </button>
          </form>
        </article>
        ...
        <article className="settings-card">
          ...
          <p className="settings-help">
            الحساب الحالي: {savedUser.name || savedUser.email || "مدير النظام"}
          </p>
        ...
        <article className="settings-card">
          ...
          <p className="settings-help">
            عند حدوث مشكلة، أرسل صورة الخطأ ورقم الإصدار الظاهر في البرنامج.
          </p>
          <div className="support-actions">
            <a href="mailto:support@alaboud.local?subject=ALABOUD%20Business%20Suite%20Support">
              ✉️ البريد الفني
            </a>
            <button
              type="button"
              onClick={() =>
                navigator.clipboard
                  ?.writeText("v16.0.15 Enterprise")
                  .then(() => setMessage("تم نسخ رقم الإصدار"))
              }
            >
              📋 نسخ رقم الإصدار
            </button>
        ...
        <article className="settings-card settings-updates-card">
          ...
          <p className="settings-help">
            {updateInfo.status || "اضغط للتحقق من حالة الخدمة والتحديث."}
          </p>
          <button
            type="button"
            className="settings-primary-button"
...
function Simple({ type }) {
  ...
  async function add(e) {
    ...
    await api.post(
      ...
      type === "expenses"
        ? { title, amount }
        : { type: move, amount, description: title },
    );
    setTitle("");
    setAmount("");
    load();
  ...
  return (
    <>
      <h2>{type === "expenses" ? "المصروفات" : "رأس المال"}</h2>
      <form className="card form" onSubmit={add}>
        {type === "capital" && (
...
export default function App() {
  ...
  const [companyBrand, setCompanyBrand] = useState({
    name: savedCompanyUser.companyName || "شركة العبود التجارية",
    logoDataUrl: "",
  });
  ...
  useEffect(() => {
    ...
    api
      ...
      .then(({ data }) => {
        localStorage.setItem("afs_user", JSON.stringify(data.user));
        window.dispatchEvent(
          new CustomEvent("alaboud-live-session", { detail: data }),
        );
      })
      .catch(() => {});
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("alaboud-auth-expired", handleAuthExpired);
  }, []);
  ...
  if (!token) {
    return (
      <Login onLogin={() => setToken(localStorage.getItem("afs_token"))} />
    );
  }
  ...
  if (invoiceId) {
    content = (
      <Invoice transactionId={invoiceId} back={() => setInvoiceId(null)} />
    );
  } else if (statementCustomerId) {
    content = (
      <Statement
        customerId={statementCustomerId}
        back={() => setStatementCustomerId(null)}
      />
    );
  } else if (customerId) {
    content = (
  ...
  const menu = [
    ...
    [
      "customers",
      `👥 العملاء${overdueCount ? ` — متأخرون (${overdueCount})` : ""}`,
    ],
    ["partners", "🏢 الشركات"],
  ...
  return (
    <>
      <AppLanguageBridge />
      <div
        className={`app ${mobileMenuOpen ? "mobile-menu-view" : "mobile-page-view"}`}
      >
        <div className="mobile-page-header no-print">
          <button
            className="mobile-header-action mobile-menu-action"
          ...
          <div className="mobile-brand-center">
            <img
              ...
              src={companyBrand.logoDataUrl || "/alaboud-company-logo.webp"}
              alt={companyBrand.name}
            />
            <div className="mobile-brand-copy">
              <strong>{companyBrand.name}</strong>
              <small>v16.0.15 Enterprise</small>
            </div>
          </div>
          <button
            className="mobile-header-action mobile-home-action"
            onClick={() => setMobileMenuOpen(true)}
        ...
        <aside>
          <div className="mobile-menu-heading no-print">
            <img
              className="alaboud-sidebar-logo mobile-logo"
              src={companyBrand.logoDataUrl || "/alaboud-company-logo.webp"}
              alt={companyBrand.name}
            />
          ...
          <div className="sidebar-logo-wrap">
            <img
              className="alaboud-sidebar-logo"
              src={companyBrand.logoDataUrl || "/alaboud-company-logo.webp"}
              alt={companyBrand.name}
            />
          </div>
          ...
          <button
            className="logout-top sidebar-logout-bottom"
          ...
          {logoutConfirm && (
            <div
              className="logout-confirm-overlay no-print"
        ...
        <main className="app-main-content">
          <AppErrorBoundary
            key={`${page}-${customerId}-${invoiceId}-${statementCustomerId}-${partnerId}`}
          >
            {content}
          </AppErrorBoundary>
          {showHomeButton && (
            <div className="home-return-bar home-return-bottom no-print">
              <button
        ...
        <nav className="mobile-bottom-nav no-print" aria-label="التنقل السريع">
          ...
          <button
            className={page === "monthly-report" ? "active" : ""}
