...
function SettingsPanel(){
  ...
  const [message,setMessage]=useState("");
  const [updateInfo,setUpdateInfo]=useState({checking:false,status:"",version:"v15.3.44 Final"});
  ...
  return <section className="settings-page">
    <div className="settings-hero">
      ...
      <span className="settings-version">v15.3.44 Final</span>
    </div>
    ...
    <div className="settings-grid">
      ...
      <article className="settings-card">
        ...
        <div className="support-actions">
          ...
          <button type="button" onClick={()=>navigator.clipboard?.writeText("v15.3.44 Final").then(()=>setMessage("تم نسخ رقم الإصدار"))}>📋 نسخ رقم الإصدار</button>
        </div>
      </article>
...
export default function App(){
  ...
  return <><AppLanguageBridge/><div className={`app ${mobileMenuOpen?"mobile-menu-view":"mobile-page-view"}`}>
    <div className="mobile-page-header no-print">
      ...
      <div className="mobile-brand-center"><img className="mobile-header-logo" src={companyBrand.logoDataUrl||"/alaboud-company-logo.webp"} alt={companyBrand.name}/><small>v15.3.44 Final</small></div>
    ...
    <aside>
      ...
      <div className="sidebar-account-box no-print">
        <div>
          ...
          <small>v15.3.44 Final Mobile</small>
        </div>
      </div>
