...
assert(api.includes('method==="get"?45000:15000'),'write requests must have bounded browser timeout');
assert(api.includes('_alaboudWriteReplayCount:replayCount+1,timeout:15000'),'idempotent replay must also be bounded');
