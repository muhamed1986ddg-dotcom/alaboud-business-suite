...
assert(api.includes('{headers,timeout:5000,withCredentials:true}'),'ambiguous commit status verification must be bounded');
assert(api.includes('OPERATION_CONFIRMATION_DELAYS=[500,1000,1500,2500,4000]'),'confirmation polling must be bounded');
