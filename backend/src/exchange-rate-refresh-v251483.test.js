...
const refreshStart=source.indexOf('async function saveAutomaticRatesBatch');
const refresh=source.slice(refreshStart,source.indexOf('registerTreasuryRoutes(app',refreshStart));
