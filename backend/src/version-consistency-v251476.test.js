...
const expected = "25.14.88";
const expectedAndroid = "25.14.88";
const checks = [
...
assert(gradle.includes("versionCode = 251488"), "Android versionCode mismatch");
assert(
...
console.log("version consistency compatibility check web/backend v25.14.88 / Android shell v25.14.88: OK");
