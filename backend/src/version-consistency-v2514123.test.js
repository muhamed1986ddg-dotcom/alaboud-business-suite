...
assert(gradle.includes('versionName = "25.14.123"'));
assert(gradle.includes('versionCode = 2514123'));
assert(fs.readFileSync(path.join(root,"app/src/main/java/com/alaboud/businesssuite/MainActivity.kt"),"utf8").includes('CLIENT_VERSION = "25.14.123"'));
assert(fs.readFileSync(path.join(root,"frontend/src/api.js"),"utf8").includes('X-Alaboud-Client-Version"]="25.14.123"'));
assert(fs.readFileSync(path.join(root,"frontend/src/version.js"),"utf8").includes('v25.14.123'));
...
console.log("version consistency v25.14.123: OK");
