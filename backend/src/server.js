...
app.get("/api/health", (_req,res)=>res.json({status:"ok",version:"15.3.42",channel:"enterprise-alpha",cloud:true}));
...
async function startServer(){
  ...
  console.log(`AlAboud Enterprise Cloud v15.3.42 running on port ${PORT}`);
