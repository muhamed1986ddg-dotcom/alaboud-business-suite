# v25.12.6 — Per-transfer financial integrity

- منع استخدام متوسط سعر التحويل في حسابات العملاء والتقارير.
- اعتماد سعر كل حوالة من سجلها نفسه: finalRate ثم الحقول القديمة عند غيابه فقط.
- إعادة حساب القيمة الكندية، ربح فرق السعر، إجمالي الربح، ورصيد العميل من البيانات الأصلية بدل الحقول المشتقة القديمة.
- إزالة بطاقة السعر الإجمالية المضللة من سجل العميل؛ السعر ظاهر داخل كل صف/بطاقة حوالة.
- توحيد الحساب في لوحة التحكم، الأرباح، التقرير الشهري، كشف العميل، الفاتورة، والدين غير المدفوع.
- إضافة اختبارات رقمية تمنع رجوع قيمة 12.6654 عندما يكون finalRate هو 1.4700.
