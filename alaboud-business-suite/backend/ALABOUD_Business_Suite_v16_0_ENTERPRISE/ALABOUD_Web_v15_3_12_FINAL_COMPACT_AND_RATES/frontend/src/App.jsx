      ...
      <div className="premium-summary panel-dark dashboard-price-bulletin">
        ...
        <div className="dashboard-rate-list">
          ...
          >
            ...
            <div className="dashboard-rate-numbers">
...
export default function App(){
  ...
  return <div className={`app ${mobileMenuOpen?"mobile-menu-view":"mobile-page-view"}`}>
    <div className="mobile-page-header no-print">
      ...
      <div className="mobile-brand-center"><img className="mobile-header-logo" src="/alaboud-company-logo.webp" alt="شركة العبود التجارية"/><small>v15.3.12 Final</small></div>
    ...
    <aside>
      ...
      <div className="sidebar-account-box no-print">
        <div>
          ...
          <small>v15.3.12 Final Mobile</small>
        </div>
