...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loadApplicationWithFreshSession()
    }

    private fun loadApplicationWithFreshSession() {
        val preferences = getSharedPreferences("alaboud_mobile", Context.MODE_PRIVATE)
        val resetKey = "webview_session_reset_v15_3_76"

        // Clean the old WebView session once after installing this update.
        // Future launches keep the new login session and simply reload the live website.
        if (preferences.getBoolean(resetKey, false)) {
        ...
        CookieManager.getInstance().removeAllCookies {
            ...
            preferences.edit().putBoolean(resetKey, true).apply()
